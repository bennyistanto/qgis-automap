    ...
    <rasterrenderer opacity="1" alphaBand="-1" band="1" classificationMin="-1" classificationMax="inf" type="singlebandpseudocolor">
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" classificationMode="1" clip="0">
          ...
          <item alpha="255" value="150" label="100 - 150 mm" color="#a0c787"/>
          <item alpha="255" value="200" label="150 - 200 mm" color="#68ab79"/>
          <item alpha="255" value="250" label="200 - 250 mm" color="#9beafa"/>
          <item alpha="255" value="300" label="250 - 300 mm" color="#00b1de"/>
          <item alpha="255" value="350" label="300 - 350 mm" color="#005ae6"/>
          <item alpha="255" value="400" label="350 - 400 mm" color="#0000c8"/>
          <item alpha="255" value="500" label="400 - 500 mm" color="#a002fa"/>
          <item alpha="255" value="600" label="500 - 600 mm" color="#fa78fa"/>
          <item alpha="255" value="inf" label="> 600 mm" color="#ffc4ee"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
