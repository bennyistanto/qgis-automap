    ...
    <rasterrenderer opacity="1" alphaBand="-1" band="1" classificationMin="-1" classificationMax="inf" type="singlebandpseudocolor">
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" classificationMode="1" clip="0">
          ...
          <item alpha="255" value="400" label="300 - 400 mm" color="#005ae6"/>
          <item alpha="255" value="500" label="400 - 500 mm" color="#0000c8"/>
          <item alpha="255" value="600" label="500 - 600 mm" color="#a002fa"/>
          <item alpha="255" value="800" label="600 - 800 mm" color="#fa78fa"/>
          <item alpha="255" value="inf" label="> 800 mm" color="#ffc4ee"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
