    ...
    <rasterrenderer opacity="1" alphaBand="-1" band="1" classificationMin="-1" classificationMax="inf" type="singlebandpseudocolor">
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" classificationMode="1" clip="0">
          ...
          <item alpha="255" value="3" label="1 - 3 mm" color="#faf3d2"/>
          <item alpha="255" value="10" label="3 - 10 mm" color="#dae3a1"/>
          <item alpha="255" value="20" label="10 - 20 mm" color="#a0c787"/>
          <item alpha="255" value="30" label="20 - 30 mm" color="#68ab79"/>
          <item alpha="255" value="50" label="30 - 50 mm" color="#9beafa"/>
          <item alpha="255" value="70" label="50 - 70 mm" color="#00b1de"/>
          <item alpha="255" value="90" label="70 - 90 mm" color="#005ae6"/>
          <item alpha="255" value="120" label="90 - 120 mm" color="#0000c8"/>
          <item alpha="255" value="150" label="120 - 150 mm" color="#a002fa"/>
          <item alpha="255" value="200" label="150 - 200 mm" color="#fa78fa"/>
          <item alpha="255" value="inf" label="> 200 mm" color="#ffc4ee"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
